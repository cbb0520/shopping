...
public class Goods {
    ...
    public Goods(Integer gid, Classify classify, String code, String gname, String gimgs, Integer limit, Integer soid, Float price, Integer udele, Integer count, String wid, Boolean select) {
        this.gid = gid;
        this.classify = classify;
        this.code = code;
        this.gname = gname;
